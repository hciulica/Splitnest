            ...
            .catch((re) => {
               ...
               switch (errorCode) {
                  ...
                  case "auth/user-not-found":
                     Alert.alert(
                        "Error",
                        "There is no account with the credentials entered"
                     );
                     break;
                  ...
                  case "auth/internal-error":
                     Alert.alert(
                        "Error",
                        "Please enter password of your email"
                     );
                     break;
         ...
         .catch((re) => {
            ...
            switch (errorCode) {
               ...
               case "auth/user-disabled":
                  Alert.alert(
                     "Banned account",
                     "Account with email " + email + " has been disabled"
                  );
                  break;
      ...
      sendPasswordResetEmail(authentication, emailReset)
         ...
         .catch((error) => {
            ...
            switch (errorCode) {
               ...
               case "auth/missing-email":
                  Alert.alert("Invalid email", "Please enter an email", [
